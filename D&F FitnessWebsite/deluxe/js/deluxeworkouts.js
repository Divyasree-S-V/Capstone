...
function myGreeting() {
  ...
  var value1 = localStorage.getItem("value5");
  document.getElementById("result5").innerHTML = value1;
  var value3 = localStorage.getItem("value6");
  document.getElementById("result6").innerHTML = value3;
...
function myFunction(){
  var value4= localStorage.getItem("value5");
  if(value4 < 18.5){
